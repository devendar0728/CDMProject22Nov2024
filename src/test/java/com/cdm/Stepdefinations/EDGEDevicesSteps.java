...
//	  EdgeDevicesPage edp = new EdgeDevicesPage(driver, logger);
//	  Assert.assertEquals("Tooltip for edge device delete button", "Delete",
//				edp.get_Text_deleteToolTip());
//	}
//
//	@Then("verify tooltip text for console on Edge Device")
//	public void verify_tooltip_text_for_console_on_edge_device() {
//		 EdgeDevicesPage edp = new EdgeDevicesPage(driver, logger);
//		  Assert.assertEquals("Tooltip for edge device console button", "Console",
//					edp.get_Text_ConsoleToolTip());
//	}
//
//
