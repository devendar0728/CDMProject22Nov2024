...
public class UserRolePermission extends CommonActions {
	...
	public void permissionInput(String value) {
		...
		jsExecutor.executeScript("arguments[0].focus();", permissionInput);
...
//		permissionInput.sendKeys(value);
	...
	WebElement outerlayerclick;
		...
		@FindBy(xpath= "//mat-sidenav-content/div[2]/div/app-role-mapping/div[3]/div/button[1]")
	WebElement saveElement;
		public void savebutton() {
			clickElement(saveElement, "Clicking on save button");
